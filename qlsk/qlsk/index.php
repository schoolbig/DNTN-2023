                        ...
                        <div class="nk-sidebar-menu">
                            ...
                            <ul class="nk-menu apps-menu">
                                <li class="nk-menu-item">
                                    <a href="index.php" class="nk-menu-link" title="CMS Panel">
                                        <span class="nk-menu-icon"><em class="icon ni ni-template"></em></span>
                                    </a>
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-hr"></li>
                                <li class="nk-menu-item">
                                    <a href="index.php" class="nk-menu-link" title="Analytics Dashboard">
                                    ...
                                    <ul class="nk-menu nk-menu-main">
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            ...
                                            <ul class="nk-menu-sub">
                                                <li class="nk-menu-item">
                                                    <a href="/demo2/ecommerce/index.php" class="nk-menu-link"><span class="nk-menu-text">eCommerce Panel</span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="/demo3/apps/file-manager.html" class="nk-menu-link"><span class="nk-menu-text">File Manangement Panel</span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="/demo4/subscription/index.php" class="nk-menu-link"><span class="nk-menu-text">Subscription Panel</span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="/demo5/crypto/index.php" class="nk-menu-link"><span class="nk-menu-text">Crypto Buy Sell Panel</span></a>
                                                </li>
                                                <li class="nk-menu-item">
                                                    <a href="/demo6/invest/index.php" class="nk-menu-link"><span class="nk-menu-text">HYIP Investment Panel</span></a>
                                                </li>
                                            </ul><!-- .nk-menu-sub -->
                                        </li><!-- .nk-menu-item -->
                                    </ul>
                    ...
                    <div class="nk-sidebar-inner" data-simplebar>
                        <ul class="nk-menu nk-menu-md">
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                                        <a href="page-add.html" class="nk-menu-link"><span class="nk-menu-text">Add Page</span></a>
                                    </li>
                                     <li class="nk-menu-item">
                                        <a href="page-list.html" class="nk-menu-link"><span class="nk-menu-text">Page List</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="page-sample.html" class="nk-menu-link"><span class="nk-menu-text">Sample Page</span></a>
                                    </li>
                                </ul><!-- .nk-menu-sub -->
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                                        <a href="post-list.html" class="nk-menu-link"><span class="nk-menu-text">All Post</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="post-add.html" class="nk-menu-link"><span class="nk-menu-text">Add Post</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="categories.html" class="nk-menu-link"><span class="nk-menu-text">Categories</span></a>
                                    </li>
                                </ul><!-- .nk-menu-sub -->
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                                <a href="media.html" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-img"></em></span>
                                    <span class="nk-menu-text">Media</span>
                                </a>
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                                <a href="comments.html" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-comments"></em></span>
                                    <span class="nk-menu-text">Comments</span>
                                </a>
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                                <a href="themes.html" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-color-palette"></em></span>
                                    <span class="nk-menu-text">Themes</span>
                                </a>
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item has-sub">
                                <a href="#" class="nk-menu-link nk-menu-toggle">
                            ...
                            <li class="nk-menu-item has-sub">
                                ...
                                <ul class="nk-menu-sub">
                                    <li class="nk-menu-item">
                                        <a href="user-list.html" class="nk-menu-link"><span class="nk-menu-text">User List</span></a>
                                    </li>
                                    <li class="nk-menu-item">
                                        <a href="user-profile.html" class="nk-menu-link"><span class="nk-menu-text">User Profile</span></a>
                                    </li>
                                </ul><!-- .nk-menu-sub -->
                            </li><!-- .nk-menu-item -->
                            <li class="nk-menu-item">
                                <a href="settings-general.html" class="nk-menu-link">
