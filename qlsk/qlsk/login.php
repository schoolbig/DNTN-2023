        ...
        $("#btn_login").click(function(e) {
            ...
            Swal.fire({
                ...
                <row style="display: inline-block">
                    <input type="radio" id="admin" name="op" value="admin">
                    <label for="admin">Admin</label><br>
                    <input type="radio" id="cashier" name="op" value="cashier">
                    <label for="cashier">Thu ngân</label><br>
                    <input type="radio" id="admin" name="op" value="doctor">
                    <label for="doctor">Bác sĩ</label><br>
                </row>
